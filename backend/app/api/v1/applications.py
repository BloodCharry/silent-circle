...
from app.models.application import Application  # type: ignore
from app.schemas.application import ApplicationCreate, ApplicationRead  # type: ignore
...
async def get_application(application_id: str, session: AsyncSession = Depends(get_session)):
